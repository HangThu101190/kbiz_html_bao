(function () {
  ...
  // ── Footer HTML ───────────────────────────────────────────────────────────
  var FOOTER_HTML = '\n  <footer class="relative w-full overflow-hidden bg-white py-10 px-6 md:px-10 md:py-14 flex flex-col justify-between">\n    <div class="absolute inset-0 z-0 pointer-events-none" style="background: radial-gradient(circle at 10% 20%, rgba(200,100,255,0.35) 0%, transparent 50%), radial-gradient(circle at 80% 50%, rgba(200,255,200,0.35) 0%, transparent 50%), radial-gradient(circle at 90% 90%, rgba(220,150,255,0.35) 0%, transparent 50%)"></div>\n    <div class="z-10 w-full mb-8">\n      <img src="' + ROOT + 'public/images/logo.png" alt="K-Biz Consulting" class="h-16 md:h-20 object-contain" />\n    </div>\n    <div class="z-10 w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-end pb-2">\n      <div class="md:col-span-4">\n        <h3 class="text-[11px] font-bold uppercase text-black mb-4 tracking-widest">Location</h3>\n        <p class="text-[13px] text-[#333] leading-relaxed">16A Le Quy Don St, Nha Trang Ward,<br/>Khanh Hoa Province</p>\n      </div>\n      <div class="md:col-span-4">\n        <h3 class="text-[11px] font-bold uppercase text-black mb-4 tracking-widest">Contact</h3>\n        <div class="flex flex-col text-[13px] text-[#333] space-y-1">\n          <a href="mailto:kbizconsulting16@gmail.com" class="hover:text-[#B800FF] transition-colors">kbizconsulting16@gmail.com</a>\n          <a href="mailto:info@kbiz.com.vn" class="hover:text-[#B800FF] transition-colors">info@kbiz.com.vn</a>\n          <p>(0258) 3516 343</p>\n        </div>\n      </div>\n      <div class="md:col-span-4 flex flex-col items-start md:items-end gap-2">\n        <p class="text-[11px] text-[#333] tracking-widest uppercase">\xA9 K-BIZ CONSULTING</p>\n      </div>\n    </div>\n  </footer>\n  ';
